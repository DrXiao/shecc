...
# System V AMD64 Calling Convention Compliance Test Suite
...
# Banner
echo -e "${BLUE}${BOLD}========================================${NC}"
echo -e "${BLUE}${BOLD}System V AMD64 Calling Convention Compliance Test Suite${NC}"
echo -e "${BLUE}${BOLD}========================================${NC}"
echo -e "Stage:       $STAGE"
...
test_one_arg()
{
    run_abi_test "One argument (rdi)" "Parameter Passing" '
#include <stdio.h>
...
test_two_args()
{
    run_abi_test "Two arguments (rdi, rsi)" "Parameter Passing" '
#include <stdio.h>
...
test_four_args()
{
    run_abi_test "Four arguments (rdi-rcx)" "Parameter Passing" '
#include <stdio.h>
...
test_five_args()
{
    run_abi_test "Five arguments (rdi-r8)" "Parameter Passing" '
#include <stdio.h>
